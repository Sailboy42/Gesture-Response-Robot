"""
Inspects the class labels in the dataset.
Lists all unique class IDs found in the label files.
Assumes dataset is organized in 'train', 'valid', and 'test' subfolders, e.g.:
